...
class ARecordFetcher:
    @staticmethod
    def Fetches_A_records(domain):
        """
    ...
    @classmethod
    def get_a_records(cls, domain):
        a_records = cls.Fetches_A_records(domain)  # Accessing static method
        if a_records:
            cls.save_to_file(f"{domain}_A.txt", domain, a_records)  # Accessing static method
